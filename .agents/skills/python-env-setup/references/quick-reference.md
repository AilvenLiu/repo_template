...
### Diagnose Issues
```bash
python3 .agents/scripts/python-env-setup/diagnose.py
```

### Fix Issues
```bash
python3 .agents/scripts/python-env-setup/fix.py
```

### Verify Configuration
```bash
python3 .agents/scripts/python-env-setup/verify.py
```
...
**Solution:**
1. Run diagnostics: `python3 .agents/scripts/python-env-setup/diagnose.py`
...
# 5. Install Poetry
# Install pipx with the operating system package manager first
pipx ensurepath
pipx install poetry
